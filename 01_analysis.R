...
gmt_dir <- Sys.getenv("GMT_DIR", unset = file.path(getwd(), "gene_sets"))
...
if (requireNamespace("fgsea", quietly = TRUE) && !is.na(gmt_file)) {
  ...
  cat("\n[skip] Supp 2b/2c fGSEA: need fgsea + a GO:CC GMT in the gene_sets/ folder",
      "(or set the GMT_DIR environment variable).\n",
